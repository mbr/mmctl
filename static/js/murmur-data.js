murmurConfigurationOptions = {
	...
	autobanattempts: "How many login attempts do we tolerate from one IP inside a given timeframe before we ban the connection?</p><p>Note that this is global (shared between all virtual servers), and that it counts both successfull and unsuccessfull connection attempts. Set either Attempts or Timeframe to 0 to disable.",
	autobantimeframe: "The timeframe for automatic bans. Exceeding the allowed number of attempts inside this timeframe (in seconds) will result in a ban.",
	autobanTime: "Duration of an automatic ban, in seconds.",
